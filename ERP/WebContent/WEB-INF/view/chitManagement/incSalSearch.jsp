	...
	<form action="#">
		<table border="1" align="center">
			...
			<tr>
				...
				<td>
 				<input  type="text" />
 				<img src="resources/images/kitty.png" alt="img" width="15px" />
			...
			<tr>
				<th>매입/매출구분</th>
				<td>
				<input type="radio" name="salSec" value="inc/sec">매입/매출 
				<input type="radio" name="salSec" value="sal">매출 
				<input type="radio" name="salSec" value="inc">매입 
				<input type="radio" name="salSec" value="매출집">매출집계
				<input type="radio" name="salSec" value="매입집">매입집계
				</td>
			</tr>
			<tr>
				<th>순서</th>
				<td>
				<input type="radio" name="순서" value="일자순">일자순
				<input type="radio" name="순서" value="거래처명">거래처명 
				<input type="radio" name="순서" value="구분순">구분순
				<input type="radio" name="순서" value="거래처코드">거래처코드 
			</tr>
		</table>	
	</form>
	<input type="button" value="검색(F8)">
		</div>
	</div>
</div>
</body>
